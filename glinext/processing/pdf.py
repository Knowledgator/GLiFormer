"""PDF preprocessing helpers for GLiNExT layout inference."""
...
class GLiNextPDFProcessor:
    """Convert PDFs or pre-extracted PDF fields into layout inference rows.

    The output is a list of dictionaries consumable by ``GLiNextLayoutProcessor``:
