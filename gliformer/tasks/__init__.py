"""Task head abstractions for GLiFormer modular architecture."""
...
class TaskHead(ABC, nn.Module):
    ...
    def from_config(cls, config, **kwargs) -> Optional["TaskHead"]:
        """Construct from GLiFormerConfig, returning None if this head is disabled."""
        ...
...
class TaskDefinition:
    """Registry entry for a concrete GLiFormer task."""
...
TASK_REGISTRY = TaskRegistry(
    [
        TaskDefinition("ner", "gliformer.tasks.ner.model", "NERHead", "text"),
        TaskDefinition("classification", "gliformer.tasks.classification.model", "ClassificationHead", "text"),
        TaskDefinition("count", "gliformer.tasks.count.model", "CountHead", "text"),
        TaskDefinition("joint_relex", "gliformer.tasks.joint_relex.model", "JointRelexHead", "text"),
        TaskDefinition("open_relex", "gliformer.tasks.open_relex.model", "OpenRelexHead", "text"),
        TaskDefinition("structuring", "gliformer.tasks.structuring.model", "StructuringHead", "text"),
        TaskDefinition("image_classification", "gliformer.tasks.vision.model", "ImageClassificationHead", "vision"),
        TaskDefinition("object_detection", "gliformer.tasks.vision.model", "ObjectDetectionHead", "vision"),
        TaskDefinition("segmentation", "gliformer.tasks.vision.model", "SegmentationHead", "vision"),
        TaskDefinition("audio_classification", "gliformer.tasks.audio.model", "AudioClassificationHead", "audio"),
        TaskDefinition("audio_segmentation", "gliformer.tasks.audio.model", "AudioSegmentationHead", "audio"),
        TaskDefinition("embedding", "gliformer.tasks.embedding.model", "EmbeddingHead", "text"),
    ]
)
