...
class GLiFormerConfig(BaseGLiNERConfig):
    model_type = "gliformer"
    ...
    def _migrate_detection_config(
        ...
        *,
        ...
        GLiFormerConfig._migrate_non_span_config(config)
...
class GLiFormerLayoutConfig(GLiFormerTextConfig):
...
class GLiFormerVisionConfig(GLiFormerConfig):
    """Vision-only bi-encoder GLiFormer config."""

    model_type = "gliformer-vision"
...
class GLiFormerAudioConfig(GLiFormerConfig):
    """Audio-only bi-encoder GLiFormer config."""

    model_type = "gliformer-audio"
...
class GLiFormerOmniConfig(GLiFormerConfig):
    """Omni config that can combine text, vision, audio, and layout settings."""

    model_type = "gliformer-omni"
...
GLIFORMER_MODEL_TYPE_TO_CONFIG_CLASS = {
    GLiFormerTextConfig.model_type: GLiFormerTextConfig,
    GLiFormerLayoutConfig.model_type: GLiFormerLayoutConfig,
    GLiFormerVisionConfig.model_type: GLiFormerVisionConfig,
    GLiFormerAudioConfig.model_type: GLiFormerAudioConfig,
    GLiFormerOmniConfig.model_type: GLiFormerOmniConfig,
}

GLIFORMER_MODEL_TYPE_TO_VARIANT = {
    GLiFormerTextConfig.model_type: "text",
    GLiFormerLayoutConfig.model_type: "layout",
    GLiFormerVisionConfig.model_type: "vision",
    GLiFormerAudioConfig.model_type: "audio",
    GLiFormerOmniConfig.model_type: "omni",
}

GLIFORMER_VARIANT_TO_CONFIG_CLASS = {
    "text": GLiFormerTextConfig,
    "layout": GLiFormerLayoutConfig,
    "vision": GLiFormerVisionConfig,
    "audio": GLiFormerAudioConfig,
    "omni": GLiFormerOmniConfig,
}


def resolve_gliformer_config_class(config_dict: dict[str, Any]):
    model_type = config_dict.get("model_type")
    if model_type in GLIFORMER_MODEL_TYPE_TO_CONFIG_CLASS:
        return GLIFORMER_MODEL_TYPE_TO_CONFIG_CLASS[model_type]
    if model_type not in {None, GLiFormerConfig.model_type}:
        raise ValueError(
            "model_type must be one of "
            f"{sorted(GLIFORMER_MODEL_TYPE_TO_CONFIG_CLASS)}, got {model_type!r}."
        )
