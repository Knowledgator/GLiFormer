"""GLiFormer decoder — factory that assembles per-task decoders based on config."""
...
class GLiFormerDecoder:
    ...
    def __init__(self, config: GLiFormerConfig):
        self.config = config
    ...
    def decode(self, model_output, classes_mapping=None, **kwargs) -> Dict:
        ...
        Args:
            model_output: GLiFormerOutput from model forward pass.
