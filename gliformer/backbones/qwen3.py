...
class GLiFormerQwen3Attention(Qwen3Attention):
...
class GLiFormerQwen3DecoderLayer(GradientCheckpointingLayer):
    def __init__(self, config: Qwen3Config, layer_idx: int):
        super().__init__()
        self.hidden_size = config.hidden_size
        self.self_attn = GLiFormerQwen3Attention(config=config, layer_idx=layer_idx)
...
class GLiFormerQwen3Model(Qwen3PreTrainedModel):
    ...
    _no_split_modules = ["GLiFormerQwen3DecoderLayer"]
    ...
    def __init__(self, config: Qwen3Config):
        ...
        self.layers = nn.ModuleList(
            [GLiFormerQwen3DecoderLayer(config, layer_idx) for layer_idx in range(config.num_hidden_layers)]
        )
...
Qwen3BidirectionalModel = GLiFormerQwen3Model

__all__ = [
    "GLiFormerQwen3Attention",
    "GLiFormerQwen3DecoderLayer",
    "GLiFormerQwen3Model",
